...
function executeSearch(indices, searchQuery) {
    // fetch('https://search.isabelle.in.tum.de/v1/default_Isabelle2020_AFP2020/search', {
    //     method: 'POST',
    //     headers: {
    //         'Content-Type': 'text/plain',
    //         accept: 'application/json',
    //     },
    //     body: '{"filters": [{"field": "SourceCode","filter": {"Term": {"inner": "prime"}}}],"pageSize": 5}'
    // })
...
function handleClick(event) {
    event.preventDefault() // so that two click events are registered
    var input = document.getElementById("searchInput")
